...
function M.createUserSettingsDefaults()
    return T{
        ...
        -- Vana'Dial settings
        showVanaDial = true,
        vanaDialHideOnMenuFocus = false,
        vanaDialVTElementColor = false,
        vanaDialShowLocalTime = true,
        vanaDialShowMoonPercent = true,
        vanaDialShowPastFuture = true,
        vanaDialPastFutureOpacity = 0.35,
        vanaDialShowWeather = true,
        vanaDialWeatherSide  = 'right',
        vanaDialWeatherAlign = 'left',
        vanaDialWeatherCustomScale = false,
        vanaDialWeatherIconSize    = 28,
        vanaDialWeatherAdjustElemental  = false,
        vanaDialWeatherElementalIconSize = 42,
        vanaDialWeatherHideNonElemental  = false,
        vanaDialTodSide      = 'left',
        vanaDialTodAlign     = 'left',
        vanaDialTodCustomScale     = false,
        vanaDialTodIconSize        = 28,
        vanaDialScale = 1.0,
        vanaDialFontSize = 12,
        vanaDialIconSize = 28,
        vanaDialBackgroundTheme = 'Plain',
        vanaDialBorderTheme = 'Plain',
        vanaDialBgScale = 1.0,
        vanaDialBorderScale = 1.0,
        vanaDialBackgroundOpacity = 0.85,
        vanaDialBorderOpacity = 1.0,
        vanaDialTooltipDirection = 'above',
        vanaDialShowTooltip = true,
        vanaDialTooltipFenrir = true,
        vanaDialTooltipSeleneBow = true,
        vanaDialShowSettingsBtn = true,
        vanaDialEnableTooltips = true,
        vanaDialTipVT      = true,
        vanaDialTipLT      = true,
        vanaDialTipTod     = true,
        vanaDialTipWeather = true,
        vanaDialShowTimers = true,
        vanaDialTimerSide = 'above',
        vanaDialTimersFontSize = 12,
        vanaDialTimersAutoCloseClick = false,
        vanaDialTimersAutoCloseIdle  = false,
        vanaDialTimersAutoCloseIdleSec = 5,
        vanaDialTimerSections = T{
            airships = false,
            boats    = false,
            rse      = false,
            lunar    = false,
